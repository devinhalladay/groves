...
export const useConnectionMutation = () => {
  const [updateConnection, { loading: updatingConnection, error: errorUpdatingConnection }] =
  ...
  const [removeConnection, { loading: removingConnection, error: errorRemovingConnection }] =
  ...
  const [createConnection, { loading: creatingConnection, error: errorCreatingConnection }] =
