        ...
        <header>
          <nav>
            <div className="orchard-title">
              <a href={`https://dev.are.na/oauth/authorize?client_id=${process.env.APPLICATION_ID}&redirect_uri=${process.env.APPLICATION_CALLBACK}&response_type=code`}>https://www.are.na/<strong>devin-halladay/</strong></a>
